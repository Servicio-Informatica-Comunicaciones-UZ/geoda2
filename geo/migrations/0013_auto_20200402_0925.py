# Generated by Django 3.0.4 on 2020-04-02 07:25
...
def add_permission_to_group(apps, schema_editor):
    ...
    curso_delete = Permission.objects.get(codename='curso_delete')
    gestores.permissions.add(curso_delete)


class Migration(migrations.Migration):

    dependencies = [('geo', '0012_auto_20200330_1307')]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='curso',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='geo.Curso'),
        ),
