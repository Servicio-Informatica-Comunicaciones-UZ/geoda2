...
class SolicitaForm(ModelForm):
    ...
    def campoCategoria(self):
        ...
        self.fields['categoria'].widget.choices = Categoria.objects.filter(anyo_academico=devuelveAñoAcademicoActual()).values_list('id', 'nombre').order_by('nombre')
    ...
    def clean(self):
        ...
        if cc_nombre and cc_categoria and cc_motivo_solicitud:
            ...
            if not cc_motivo_solicitud:
                self.add_error('motivo_solicitud', 'Desarrolle el motivo de su solicitud.')
    ...
    def save(self, commit=True):
        ...
        self.instance.anyo_academico = devuelveAñoAcademicoActual() # Año académico en el que se hace la solicitud
        ...
        profesor_curso = ProfesorCurso(curso=curso, profesor=self.user, fecha_alta=datetime.now())
        profesor_curso.save()
